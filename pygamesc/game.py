...
def graficar_datos_3d(datos_modelo):
    # Extrae los valores para cada eje
    x = [dato[0] for dato in datos_modelo]
    y = [dato[1] for dato in datos_modelo]
    z = [dato[2] for dato in datos_modelo]
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                ...
                if evento.key == pygame.K_q:  # Presiona 'q' para terminar el juego
                    print("Juego terminado. Datos recopilados:", datos_modelo,"hola")
                    pygame.quit()
                    exit()
